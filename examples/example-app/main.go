...
func cmd() *cobra.Command {
	...
	c.Flags().StringVar(&a.clientID, "client-id", "test1", "OAuth2 client ID of this application.")
	c.Flags().StringVar(&a.clientSecret, "client-secret", "skes5xvkplk6vtfnj4unlxldvszxj5ao367qri3eahsn6hwszq", "OAuth2 client secret of this application.")
